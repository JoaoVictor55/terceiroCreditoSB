...
main:
	...
	li $a0, 0xffff0000
	lw $t0, 0($a0)
	ori $t0, 0x02  # use keyboard interrupts (ativa as interrupções no registrador de controle do teclado)
	sw $t0, 0($a0)
	mfc0 $t0, $12  # Status
	ori $t0, 0x01  # interrupts enable (ativa as interrupções no registrador status)
	mtc0 $t0, $12
