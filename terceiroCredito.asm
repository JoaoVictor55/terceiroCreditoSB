...
# bloco de codigo para pintar o plano de fundo
planoDeFundo:
	li $t0, 0	# muda Colunas
	...
	forExterno:
		li $t5, 0
		sll $t6, $t2, 7			#$t2 x 128 eixo y
		sll $t7, $t0, 2 		#$t0 x 4 eixo x
		...
		forInterno:
			addiu $t5, $t5, 1
   		    	sw $t3, ($t4)
	    	   	addiu $t4, $t4, 4	# pontencias de 128 pra mudar somente a coluna
  	     		bne $t5, 1024, forInterno
			
		addi $t2, $t2, 128
		addi $t0, $t0, 1
		bne $t0, $t1, forExterno 
	jr $ra
